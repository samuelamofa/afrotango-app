  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EventRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final eventViewEventRecord = snapshot.data!;
                                      ...
                                      child: Stack(
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: Image.network(
                                              eventViewEventRecord.eventImage,
                                              width: double.infinity,
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            10.0, 0.0, 10.0, 0.0),
                                        child: Text(
                                          eventViewEventRecord.eventDescription,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Inter',
                            ...
                            Padding(
                              ...
                              child: StreamBuilder<UsersRecord>(
                                stream: UsersRecord.getDocument(
                                    eventViewEventRecord.createdUserRef!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      valueOrDefault<
                                                                          String>(
                                                                        functions
                                                                            .generateOnlyDayFromDateTimeValue(rowEventRecord.eventDate),
                                                                        '27',
                                                                      ),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
