...
import 'business_filter_model.dart';
...
class _BusinessFilterWidgetState extends State<BusinessFilterWidget> {
  late BusinessFilterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessFilterModel());
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        StreamBuilder<List<BusinessCatigoryRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<BusinessCatigoryRecord>
                                rowBusinessCatigoryRecordList = snapshot.data!;
                            ...
                            return SingleChildScrollView(
                              ...
                              child: Row(
                                ...
                                children: List.generate(
                                    rowBusinessCatigoryRecordList.length,
                                    (rowIndex) {
                                  final rowBusinessCatigoryRecord =
                                      rowBusinessCatigoryRecordList[rowIndex];
                                  return InkWell(
                                    ...
                                    child: wrapWithModel(
                                      model: _model.cardbusinesModels.getModel(
                                        rowIndex.toString(),
                                        rowIndex,
                                      ),
                                      updateCallback: () => safeSetState(() {}),
                                      child: CardbusinesWidget(
                                        key: Key(
                                          'Keybin_${rowIndex.toString()}',
                                        ),
