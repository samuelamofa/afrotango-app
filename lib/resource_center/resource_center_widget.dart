...
class ResourceCenterWidget extends StatefulWidget {
  ...
  static String routeName = 'ResourceCenter';
  static String routePath = 'resourceCenter';
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(24.0, 15.0, 0.0, 15.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'xk6dqgph' /* We connect expats to resources... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'hgz0mbq2' /* Or chat with our virtual assis... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'sw6xj0qe' /* Hey! How are you doing? I saw ... */,
                                                ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'dfsgl2e0' /* Hi Sarah! I'm good, thanks! Ye... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            '9f1hgwgq' /* tell us what you want.... */,
                                          ),
