...
class CommunitySpaceWidget extends StatefulWidget {
  const CommunitySpaceWidget({
    super.key,
  ...
  @override
  State<CommunitySpaceWidget> createState() => _CommunitySpaceWidgetState();
}

class _CommunitySpaceWidgetState extends State<CommunitySpaceWidget> {
  late CommunitySpaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommunitySpaceModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CommunitiesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final communitySpaceCommunitiesRecord = snapshot.data!;
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          communitySpaceCommunitiesRecord
                                              .communityName,
                                    ...
                                    builder: (context) {
                                      ...
                                      return SingleChildScrollView(
                                        ...
                                        child: Row(
                                          mainAxisSize: MainAxisSize.max,
                                          children:
                                              List.generate(listOfUsers.length,
                                                  (listOfUsersIndex) {
                                                                ...
                                                                Padding(
                                                                  padding: const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    '${stackUsersRecord.firstName} ${stackUsersRecord.lastName}'
                                                                        .maybeHandleOverflow(
                                                                      maxChars:
                                                                          15,
                                                                      replacement:
                            ...
                            children: [
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      'Featured businesses in community',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Poppins',
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Stack(
                                                                        children: [
                                                                          if (rowCommunitiesRecord.joinedUsersRef.firstOrNull !=
                                                                              null)
                                                                            Padding(
                                                                              padding: const EdgeInsetsDirectional.fromSTEB(19.47, 0.0, 0.0, 0.0),
                                                                              child: StreamBuilder<UsersRecord>(
                                                                                stream: UsersRecord.getDocument(rowCommunitiesRecord.joinedUsersRef.firstOrNull!),
                                                                                builder: (context, snapshot) {
                                                                                  // Customize what your widget looks like when it's loading.
                                                                                  if (!snapshot.hasData) {
                                                                                    return Center(
                                                                          ...
                                                                          if (rowCommunitiesRecord.joinedUsersRef.elementAtOrNull(1) !=
                                                                              null)
                                                                            Padding(
                                                                              padding: const EdgeInsetsDirectional.fromSTEB(35.47, 0.0, 0.0, 0.0),
                                                                              child: StreamBuilder<UsersRecord>(
                                                                                stream: UsersRecord.getDocument(rowCommunitiesRecord.joinedUsersRef.elementAtOrNull(1)!),
                                                                                builder: (context, snapshot) {
                                                                                  // Customize what your widget looks like when it's loading.
                                                                                  if (!snapshot.hasData) {
                                                                                    return Center(
                                                                          ...
                                                                          if (rowCommunitiesRecord.joinedUsersRef.elementAtOrNull(2) !=
                                                                              null)
                                                                            Padding(
                                                                              padding: const EdgeInsetsDirectional.fromSTEB(51.47, 0.0, 0.0, 0.0),
                                                                              child: StreamBuilder<UsersRecord>(
                                                                                stream: UsersRecord.getDocument(rowCommunitiesRecord.joinedUsersRef.elementAtOrNull(2)!),
                                                                                builder: (context, snapshot) {
                                                                                  // Customize what your widget looks like when it's loading.
                                                                                  if (!snapshot.hasData) {
                                                                                    return Center(
                                                                          ...
                                                                          if (rowCommunitiesRecord.joinedUsersRef.elementAtOrNull(3) !=
                                                                              null)
                                                                            Padding(
                                                                              padding: const EdgeInsetsDirectional.fromSTEB(67.47, 0.0, 0.0, 0.0),
                                                                              child: StreamBuilder<UsersRecord>(
                                                                                stream: UsersRecord.getDocument(rowCommunitiesRecord.joinedUsersRef.elementAtOrNull(3)!),
                                                                                builder: (context, snapshot) {
                                                                                  // Customize what your widget looks like when it's loading.
                                                                                  if (!snapshot.hasData) {
                                                                                    return Center(
