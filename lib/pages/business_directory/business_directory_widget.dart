                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: Image.asset(
                                    'assets/images/busy-city-street-conversation-professionals_1265500-156794.jpg',
                                  ).image,
                                ),
                                borderRadius: const BorderRadius.only(
                                  bottomLeft: Radius.circular(0.0),
                            ...
                            Builder(
                              builder: (context) => InkWell(
                                ...
                                onTap: () async {
                                    ...
                                    builder: (dialogContext) {
                                      return Dialog(
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: const Action3SelectListWidget(),
                                        ),
                                      );
                                    },
                                  ...
                                  safeSetState(() {});
                                  _model.category =
                                      _model.filters!.toList().cast<String>();
                                  safeSetState(() {});
                            ...
                            child: Column(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  borderRadius: 360.0,
                                  buttonSize: 60.0,
                                  fillColor: const Color(0xFFBA0202),
                                  icon: Icon(
                                  ...
                                  onPressed: () async {
                                    _model.category = [];
                                    safeSetState(() {});
                                    _model.addToCategory('Real Estate');
                                    safeSetState(() {});
                                  },
                                ),
                                Text(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    _model.category = [];
                                    safeSetState(() {});
                                    _model.addToCategory('Restaurants');
                                    safeSetState(() {});
                                  },
                                ),
                                Text(
                            ...
                            child: Column(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  borderRadius: 360.0,
                                  buttonSize: 60.0,
                                  fillColor: const Color(0xFFAF0404),
                                  icon: Icon(
                                    FFIcons.kplug,
                                    color: FlutterFlowTheme.of(context)
                                        .secondaryBackground,
                                  ...
                                  onPressed: () async {
                                    _model.category = [];
                                    safeSetState(() {});
                                    _model.addToCategory('Electricians');
                                    safeSetState(() {});
                                  },
                                ),
                                Text(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    _model.category = [];
                                    safeSetState(() {});
                                    _model.addToCategory('Hair Saloon');
                                    safeSetState(() {});
                                  },
                                ),
                                Text(
                    ...
                    StreamBuilder<List<BusinessRecord>>(
                      stream: queryBusinessRecord(
                        queryBuilder: (businessRecord) => businessRecord
                            .whereIn('business_category', _model.category),
                      ),
                        ...
                        return SingleChildScrollView(
                          ...
                          child: Row(
                            ...
                            children: List.generate(
                                rowBusinessRecordList.length, (rowIndex) {
