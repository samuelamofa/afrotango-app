...
import '/components/action3_select_list_community_widget.dart';
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image: Image.asset(
                                        'assets/images/wxwwk_gIrLaOrmUL6MwcR-transformed.jpeg',
                                      ).image,
                                    ),
                                  ),
                                  child: Container(
                                              ...
                                              builder: (dialogContext) {
                                                return Dialog(
                                                  ...
                                                  child: GestureDetector(
                                                    ...
                                                    child:
                                                        const Action3SelectListCommunityWidget(),
                                                  ),
                                                );
                                              },
                                            ).then((value) => safeSetState(() =>
                                                _model.communityfilters =
                                                    value));

                                            _model.category = [];
                                            safeSetState(() {});
                                            _model.category = _model
                                                .communityfilters!
                                                .toList()
                                                .cast<String>();
                                            safeSetState(() {});
                            ...
                            child: StreamBuilder<List<CommunitiesRecord>>(
                              stream: queryCommunitiesRecord(
                                queryBuilder: (communitiesRecord) =>
                                    communitiesRecord.whereIn(
                                        'community_category', _model.category),
                              ),
                                  ...
                                  child: Row(
                                    ...
                                    children: List.generate(
                                      ...
                                      final rowCommunitiesRecord =
                                          rowCommunitiesRecordList[rowIndex];
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 15.0, 10.0),
