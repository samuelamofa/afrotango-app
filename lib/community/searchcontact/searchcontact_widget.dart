...
import 'searchcontact_model.dart';
export 'searchcontact_model.dart';

class SearchcontactWidget extends StatefulWidget {
  const SearchcontactWidget({super.key});

  static String routeName = 'searchcontact';
  static String routePath = 'searchcontact';
...
class _SearchcontactWidgetState extends State<SearchcontactWidget> {
  late SearchcontactModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchcontactModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> searchcontactUsersRecordList = snapshot.data!;
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (searchcontactUsersRecordList.length > 0)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 20.0, 0.0, 0.0),
                                      child: Builder(
                                        builder: (context) {
                                          final serchterms = () {
                                            ...
                                            } else if (_model.catigory !=
                                                    null &&
                                                _model.catigory != '') {
                                              return searchcontactUsersRecordList
                                                  .where((e) => e.catigory
                                                      .contains(
                                                          _model.catigory))
                                                  .toList();
                                          ...
                                          return ListView.separated(
                                            ...
                                            itemBuilder:
                                              ...
                                              return wrapWithModel(
                                                model: _model.cardmember2Models1
                                                    .getModel(
                                                ...
                                                child: Cardmember2Widget(
                                                  key: Key(
                                                    'Keyswy_${serchtermsIndex.toString()}',
                                                  ),
                                                  user: serchtermsItem,
                                                ),
                                              );
                                          ...
                                          return ListView.separated(
                                            ...
                                            itemBuilder:
                                              ...
                                              final serchtermsItem =
                                                  serchterms[serchtermsIndex];
                                              return wrapWithModel(
                                                model: _model.cardmember2Models2
                                                    .getModel(
                                                  serchtermsIndex.toString(),
                                                  serchtermsIndex,
                                                ),
                                                ...
                                                child: Cardmember2Widget(
                                                  key: Key(
                                                    'Keybtx_${serchtermsIndex.toString()}',
                                                  ),
                                                  user: serchtermsItem,
                                                ),
                                              );
                                    ...
                                    builder: (context) {
                                      ...
                                      return SingleChildScrollView(
                                        ...
                                        child: Row(
                                          mainAxisSize: MainAxisSize.max,
                                          children:
                                              List.generate(serchterm.length,
                                                  (serchtermIndex) {
                                            final serchtermItem =
                                            ...
                                            return Column(
                                              ...
                                              children: [
                                                wrapWithModel(
                                                  ...
                                                  child: CardnewWidget(
                                                    key: Key(
                                                      'Keydln_${serchtermIndex.toString()}',
                                                    ),
                                                    user: serchtermItem,
                                                  ),
                                                ),
                                            ...
                                            return Column(
                                              ...
                                              children: [
                                                wrapWithModel(
                                                  ...
                                                  child: CardnewWidget(
                                                    key: Key(
                                                      'Key2hy_${serchtermIndex.toString()}',
                                                    ),
                                                    user: serchtermItem,
                                                  ),
                                                ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (searchcontactUsersRecordList.length > 0)
                                  Builder(
                                    builder: (context) {
                                      final serch = searchcontactUsersRecordList
                                          .sortedList(
                                              keyOf: (e) => e.followers.length,
                                              desc: true)
                                          .toList()
                                          .take(20)
                                          .toList();
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    if (searchcontactUsersRecordList.length ==
                                        0)
                                      Builder(
                                        builder: (context) {
                                          final serch =
                                                    ...
                                                    Container(
                                                      ...
                                                      child: wrapWithModel(
                                                        ...
                                                        child: EmptylistWidget(
                                                          key: Key(
                                                            'Key5w0_${random_data.randomString(
                                                              0,
                                                              8,
                                                              true,
                                                              false,
