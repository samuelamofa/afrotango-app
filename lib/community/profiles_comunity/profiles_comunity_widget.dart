...
class _ProfilesComunityWidgetState extends State<ProfilesComunityWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.user!.followers.contains(currentUserReference)) {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final profilesComunityUsersRecord = snapshot.data!;
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${(widget.user!.followers.length + (_model.num!)).toString()} Followers',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              font: GoogleFonts.poppins(
