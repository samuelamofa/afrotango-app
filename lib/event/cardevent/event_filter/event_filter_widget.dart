...
class _EventFilterWidgetState extends State<EventFilterWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.country = widget.country;
      _model.intialdate = widget.intialdate;
      safeSetState(() {});
    });
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Builder(
                              builder: (context) {
                                final events =
                                    containerEventcatigoryRecordList.toList();
                                  ...
                                  child: Row(
                                    ...
                                    children: List.generate(events.length,
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          _model.category = eventsItem.name;
                                          safeSetState(() {});
                                        },
                                        child: Container(
                                          height: 54.0,
                            ...
                            FlutterFlowDropDown<String>(
                              ...
                              onChanged: (val) async {
                                ...
                                _model.country = _model.countryDropDownValue;
                                safeSetState(() {});
                              },
                              width: double.infinity,
                              height: 54.0,
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                _model.intialdate = _model.datePicked;
                                safeSetState(() {});
                              },
                              child: Container(
                                width: double.infinity,
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    if ((_model.category != null &&
                                      ...
                                      if (widget.dismiss == true) {
                                        Navigator.pop(
                                            context,
                                            functions.eventFIlter(
                                                widget.events?.toList(),
                                                _model.textController.text,
                                                _model.category,
                                                containerEventcatigoryRecordList
                                                    .toList(),
                                                _model.country,
                                                _model.intialdate));
                                      } else {
                                        context.pushNamed(
                                          EventsearchWidget.routeName,
                                          queryParameters: {
