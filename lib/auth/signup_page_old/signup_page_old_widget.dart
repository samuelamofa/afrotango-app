...
import 'signup_page_old_model.dart';
export 'signup_page_old_model.dart';

class SignupPageOldWidget extends StatefulWidget {
  const SignupPageOldWidget({super.key});

  static String routeName = 'signupPage_old';
  static String routePath = 'signupPage_old';
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '9o09xg77' /* Create an account to get start... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '7cb6eou1' /* Already have an account? */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
