                    ...
                    children: [
                      ...
                      Expanded(
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(ComunityListmyWidget.routeName);
                          },
                          child: Container(
                            width: 200.0,
                            decoration: BoxDecoration(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          if (valueOrDefault<bool>(
                            ...
                            context.goNamed(ManageverifyWidget.routeName);
                          } else {
                      ...
                      if (responsiveVisibility(
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            context
                                .pushNamed(NotificationrestuWidget.routeName);
                          },
                          child: Material(
                            color: Colors.transparent,
                            child: ListTile(
                      ...
                      if (responsiveVisibility(
                        ...
                        InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(ResourceCenterWidget.routeName);
                          },
                          child: Material(
                            color: Colors.transparent,
                            child: ListTile(
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          ...
                          context.goNamedAuth(
                              LoginPageOldWidget.routeName, context.mounted);
                        },
                        child: Material(
                          color: Colors.transparent,
                          child: ListTile(
