...
class _LoginScreenWidgetState extends State<LoginScreenWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xDDE0E3E7),
        body: Form(
          key: _model.formKey,
                                ...
                                children: [
                                  Opacity(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(30.0),
                                      child: Image.asset(
                                        'assets/images/Artboard_12@300x[1].png',
                                        width: 340.0,
                                        height: 530.0,
                                        fit: BoxFit.cover,
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '1jwecshw' /* Sign into your account */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'e4lubyhj' /* Don't have an account? */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
