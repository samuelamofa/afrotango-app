...
import 'profileshare_model.dart';
export 'profileshare_model.dart';
...
class ProfileshareWidget extends StatefulWidget {
  ...
  static String routeName = 'profileshare';
  static String routePath = 'profileshare';
...
class _ProfileshareWidgetState extends State<ProfileshareWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileshareModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final profileshareUsersRecord = snapshot.data!;
                        ...
                        children: [
                          ...
                          Builder(
                            builder: (context) => FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                await Share.share(
                                  'afrotango://afrotango.app/signupPage_old',
                                  sharePositionOrigin:
