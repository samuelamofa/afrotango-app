...
import 'buisness_model.dart';
export 'buisness_model.dart';

class BuisnessWidget extends StatefulWidget {
  const BuisnessWidget({super.key});

  @override
  State<BuisnessWidget> createState() => _BuisnessWidgetState();
}

class _BuisnessWidgetState extends State<BuisnessWidget> {
  late BuisnessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuisnessModel());
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 8.0, 0.0, 0.0),
                                      child: Text(
                                        'Blablabla about business goes here.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Poppins',
