...
class _Homepage2WidgetState extends State<Homepage2Widget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: const Color(0xFFDFAB2E),
        body: SafeArea(
          top: true,
          child: Column(
            ...
            children: [
              ...
              Container(
                height: MediaQuery.sizeOf(context).height * 0.486,
                decoration: const BoxDecoration(
                  color: Color(0xFFDFAB2E),
                ),
                child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.asset(
                                        'assets/images/group-diverse-people-standing-together-vector-illustration-cartoon-style_941097-36259.jpg',
                                        width: 80.0,
                                        height: 60.0,
                                        fit: BoxFit.cover,
                                      ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.asset(
                                        'assets/images/2098693_271783-P5O9DL-827.jpg',
                                        width: 80.0,
                                        height: 60.0,
                                        fit: BoxFit.cover,
                                      ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.asset(
                                        'assets/images/10782682_19197223.jpg',
                                        width: 80.0,
                                        height: 60.0,
                                        fit: BoxFit.cover,
                                      ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.asset(
                                        'assets/images/poster-that-says-word-it_1248089-3007.jpg',
                                        width: 60.0,
                                        height: 60.0,
                                        fit: BoxFit.cover,
                                      ),
