...
import 'marketproductlist_catigory_model.dart';
export 'marketproductlist_catigory_model.dart';

class MarketproductlistCatigoryWidget extends StatefulWidget {
  const MarketproductlistCatigoryWidget({
    super.key,
    required this.type,
  });
  ...
  static String routeName = 'marketproductlistCatigory';
  static String routePath = 'marketproductlistCatigory';

  @override
  State<MarketproductlistCatigoryWidget> createState() =>
      _MarketproductlistCatigoryWidgetState();
}

class _MarketproductlistCatigoryWidgetState
    extends State<MarketproductlistCatigoryWidget> {
  late MarketproductlistCatigoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MarketproductlistCatigoryModel());
  }
                                ...
                                children: List.generate(
                                  ...
                                  return wrapWithModel(
                                    ...
                                    child: CardmarketWidget(
                                      key: Key(
                                        'Keyhqz_${wrapFeaturedproductsIndex.toString()}',
                                      ),
                                      product:
                              ...
                              return Wrap(
                                ...
                                children: List.generate(
                                  ...
                                  return wrapWithModel(
                                    ...
                                    child: CardmarketWidget(
                                      key: Key(
                                        'Keyh6k_${wrapPopularproductsIndex.toString()}',
                                      ),
                              ...
                              return Wrap(
                                ...
                                children: List.generate(
                                  ...
                                  return wrapWithModel(
                                    ...
                                    child: CardmarketWidget(
                                      key: Key(
                                        'Keyivv_${wrapNewestproductsIndex.toString()}',
                                      ),
